...
# Helper methods.
#----------------------------------------------------------------------------#
def flash_form_validation_errors_if_any(form):
    flash("The following validations failed: ")
...
def create_venue_submission():
    ...
    if not venue_form.validate():
        flash_form_validation_errors_if_any(venue_form)
        return redirect(url_for('create_venue_form', venue_id=venue_id))
    try:
        new_venue = Venue(
...
def edit_artist_submission(artist_id):
    ...
    if not form.validate():
        flash_form_validation_errors_if_any(form)
...
def create_artist_submission():
    ...
    if not artist_form.validate():
        flash_form_validation_errors_if_any(artist_form)
